...
import com.halil.ozel.moviedb.data.models.ResponseVideo; // <-- IMPORT BARU UNTUK TRAILER
...
public interface TMDbAPI {
    ...
    // [BARU] Endpoint untuk Trailer/Video (Dari kode pertama)
    @GET(HttpClientModule.MOVIE_DETAILS + "{movie_id}/videos")
    Observable<ResponseVideo> getMovieVideos(
